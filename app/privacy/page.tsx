    ...
    <LegalPageLayout>
          ...
          <section className="space-y-3">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 space-y-2">
              <p className="font-semibold text-zinc-900">필수 항목:</p>
              <ul className="list-disc list-inside space-y-1 text-zinc-700 ml-2">
                <li>이메일, 이름, 핸드폰 번호</li>
                <li>비밀번호 (암호화되어 저장)</li>
                <li>초대 코드 (접근 제어용)</li>
              </ul>
              <p className="font-semibold text-zinc-900 mt-4">선택 항목:</p>
              <ul className="list-disc list-inside space-y-1 text-zinc-700 ml-2">
          ...
          <section className="space-y-3">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 space-y-3">
              ...
              <div>
                <p className="font-semibold text-zinc-900 mb-1">계정 탈퇴 시:</p>
                <p className="text-zinc-700 ml-4">
                  탈퇴 신청 후 14일 동안 보관 후 자동 삭제 (재가입 방지 목적)
                </p>
              </div>
              <div>
                <p className="font-semibold text-zinc-900 mb-1">로그 데이터:</p>
                <p className="text-zinc-700 ml-4">
                  3개월 보관 후 자동 삭제
                </p>
              </div>
          ...
          <section className="space-y-3">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 space-y-3">
              ...
              <div>
                <p className="text-zinc-700"><strong className="text-zinc-900">사업자등록번호:</strong> 299-86-03770</p>
              </div>
              <div>
                <p className="text-zinc-700"><strong className="text-zinc-900">대표자:</strong> 권오룡</p>
              </div>
              <div>
                <p className="text-zinc-700"><strong className="text-zinc-900">주소:</strong> 세종특별자치시 갈매로 363, 405호</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 space-y-2">
              ...
              <div className="mt-4 space-y-1 text-zinc-600 text-sm">
                <p><strong className="text-zinc-900">담당자:</strong> 개인정보 보호책임자</p>
                <p><strong className="text-zinc-900">이메일:</strong> {SUPPORT_EMAIL}</p>
              </div>
            </div>
          </section>
