  ...
  return (
    <LegalPageLayout>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-violet-900">1. 고객센터</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-violet-900">2. 사업자 정보</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-2xl font-bold text-violet-900">3. 정책 문서</h2>
        <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4 flex flex-wrap gap-3 text-sm">
          <Link href="/pricing" className="text-violet-600 hover:text-violet-700 underline underline-offset-4 font-medium">
            요금제/상품 상세
          </Link>
          <Link href="/refund-policy" className="text-violet-600 hover:text-violet-700 underline underline-offset-4 font-medium">
            환불정책
          </Link>
          <Link href="/terms" className="text-violet-600 hover:text-violet-700 underline underline-offset-4 font-medium">
            이용약관
          </Link>
          <Link href="/privacy" className="text-violet-600 hover:text-violet-700 underline underline-offset-4 font-medium">
            개인정보처리방침
          </Link>
        </div>
      </section>
