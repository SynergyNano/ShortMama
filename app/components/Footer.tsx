...
export default function Footer() {
  return (
    <footer className="border-t border-gray-200 mt-12 bg-gradient-to-r from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Links - Single Line */}
        <div className="flex flex-wrap gap-2 items-center mb-4 text-sm leading-tight justify-center">
          {/* 서비스 */}
