        ...
        {QUICK_OPTIONS.map((option) => (
          <button
            ...
            style={{
              padding: "6px 8px",
              borderRadius: "6px",
              border: selectedQuick?.label === option.label ? "2px solid #00E573" : "1px solid rgba(24, 24, 27, 0.1)",
              backgroundColor: selectedQuick?.label === option.label ? "rgba(0, 229, 115, 0.15)" : "#f4f4f5",
              color: selectedQuick?.label === option.label ? "#00FF7F" : "rgba(24, 24, 27, 0.55)",
              fontSize: "12px",
